...
interface ProjectContextType {
  ...
  createProject: (projectData: { name: string, color: string }) => Promise<Project | null>;
  deleteProject: (projectId: string) => Promise<void>;
}

const ProjectContext = createContext<ProjectContextType | undefined>(undefined);

export function ProjectProvider({ children, user }: { children: ReactNode, user: any }) {
  ...
  const createProject = async (projectData: { name: string; color: string }): Promise<Project | null> => {
    if (!user) {
